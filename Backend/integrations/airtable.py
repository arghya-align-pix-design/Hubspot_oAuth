...
CLIENT_ID = 'XXX'
CLIENT_SECRET = 'XXX'
REDIRECT_URI = "http://localhost:6299/integrations/airtable/oauth2callback"
...
# FIRST FUNCTION- MAKES THE URL , SAFE URL SO USER CAN GO TO LINK AND PROVIDE CREDENTIALS
